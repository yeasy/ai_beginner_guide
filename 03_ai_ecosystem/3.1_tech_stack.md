...
- **数据中心级**：NVIDIA H100/A100（训练大模型标配）
- **消费级**：NVIDIA RTX 4090（个人炼丹首选）
- **竞争对手**：AMD Instinct MI300

**TPU（张量处理单元）**

Google 专为 AI 设计的芯片：
- 专为 TensorFlow/JAX 优化
- 在 Google Cloud 上以服务形式提供
- 性价比在特定任务上优于 GPU

**端侧/边缘芯片**

让 AI 能在手机和汽车上运行：
- **手机**：高通骁龙 NPU、苹果 Neural Engine
- **汽车**：NVIDIA Orin、地平线征程
- **推理卡**：NVIDIA L4/T4
